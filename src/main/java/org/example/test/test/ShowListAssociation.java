...
public class ShowListAssociation {
    ...
    void OnDelete(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/test/test/AssociationFXML/Show_list_association.fxml"));
    ...
    */
    ...
    void onShowDetails(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/test/test/AssociationFXML/ShowDetailsAssociation.fxml"));
