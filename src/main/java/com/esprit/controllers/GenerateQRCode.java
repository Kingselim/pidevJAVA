...
public class GenerateQRCode
{
    ...
    public static Image generateQRCodeImage(String content) {
        try {
            // Générer le code QR et le stocker dans un fichier temporaire
            String path = "temp_qr_code.png";
            generateQRcode(content, path, "UTF-8", null, 200, 200);

            // Charger l'image depuis le fichier temporaire et la retourner en tant qu'objet Image
