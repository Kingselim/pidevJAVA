...
public class RequestsCreationAssociation {
    ...
    public void OnActive(ActionEvent event) {
        ...
        try {
            ...
            alert.showAndWait();
            Mailing.sendMail(assoc.getEmail(),"Activation de l'association","Votre association est maintenant activée .");
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/AssociationFXML/Requests_creation_association.fxml"));
