...
public class AjouterAdmin implements Initializable {
...
*/
    ...
    void cree(ActionEvent event) throws IOException, WriterException {
        ...
        String rolev="1";            // ici je donne par defaut la valeur de 0 au role pour le rendre client et 1 si c'est un admin
